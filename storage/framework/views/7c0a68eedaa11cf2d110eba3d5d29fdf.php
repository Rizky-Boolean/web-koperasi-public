...
<head>
  ...
  <title>Login - Koperasi MINDA</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2 mb-4">
                    ...
                    <p class="text-center text-muted small">Masukkan ID Admin & password untuk login</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="/">
                    ...
                    <div class="col-md-12 mb-2">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="floatingID" name="payer_id" placeholder="Your ID">
                    ...
                    <div class="col-md-12 mb-4">
                      <div class="form-floating">
                        ...
                        <label for="floatingPassword">Passsword</label>
                      </div>
                    </div>
...
<?php /**PATH /media/yunus-febriansyah/DATA1/AppProject/laravel-apps/e-koperasi-web/resources/views/layouts/login.blade.php ENDPATH**/ ?>